
{
    ...
    class Shape {
        ...
        configureShapeType() {
            this.DOM.el.style.transformOrigin = `${this.letterRect.left + this.letterRect.width/2}px ${this.letterRect.top + this.letterRect.height}px`;

            if ( this.type === 'circle' ) {
                const r = 0.25*this.letterRect.width;
                this.DOM.el.setAttribute('r', r);
                this.DOM.el.setAttribute('cx', this.letterRect.left + this.letterRect.width/1.5);
                this.DOM.el.setAttribute('cy', this.letterRect.top + this.letterRect.height/1.5);
            }
            else if ( this.type === 'rect' ) {
                const w = randomBetween(0.05,0.5,3)*this.letterRect.width/1.5;
                const h = randomBetween(0.05,0.5,3)*this.letterRect.height/1.5;
